...
<html>
<head>
    <title>Куда меня пригласили</title>
                ...
                <table class="table table-striped tablesorter"  id="myTable" >
                    ...
                    <c:forEach var="listValue" items="${projectList}">
                        <tr >
                            ...
                            <td class="text-center"><a href="/AcceptInvitation?prId=${listValue.prId}">Принять</a></td>
                            <td class="text-center"><a href="/RejectInvitation?prId=${listValue.prId}">Отклонить</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
