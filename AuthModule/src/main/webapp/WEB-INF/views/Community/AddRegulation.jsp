...
<div class="row">
    ...
    <div class="col-md-9">
        <ul class="nav">
            <li class="active">
                <a href="/community/"><h2>Новости</h2></a>
            </li>
            <ul class="nav">
        ...
        <div class="container">
            <form:form method="post" modelAttribute="regulation" action="${action}">
                ...
                <form:textarea cols="150" path="title" type="text" id="title" rows="5" value=""
                                 placeholder="Введите текст правила" class="form-control" required="true"/>
