    ...
    <div class="col-md-9">
        ...
        <div class="project-table">
            ...
            <div class="">
                ...
                <div class="col-md-2">
                    <a href="news/add-admin"><button type="button" class="btn btn-default"><h4>Добавить новость</h4></button></a>
                </div>
            </div>
                    ...
                    <c:forEach var="listValue" items="${newsList}">
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="table-responsive cell"><a href="news/${listValue.newsId}?role=admin">${listValue.text}</a></div>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
