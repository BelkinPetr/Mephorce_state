...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="container">
            <spring:form method="post" modelAttribute="News" action="AddNewsAdmin">
                <spring:select path="project" type="text" placeholder="Выберите проект" value="" id="project" class="form-control" required="true">
                    <form:options items="${projectsList}"/>
                </spring:select>
                <spring:errors path="project"/><br/>
                <spring:textarea cols="150" path="text" type="text" id="text" rows="5" value=""
                                 placeholder="Введите текст новости" class="form-control" required="true"/>
                <spring:errors path="text"/> <br/>
                <spring:button>Создать</spring:button>
            </spring:form>
        </div>

        <spring:errors path="project"/>
    </div>
</div>
