...
<div class="row">
        ...
        <div class="user-info-and-menu">
            ...
            <div class="btn-group btn-group-vertical">
                <form>
                    ...
                    <li class=""><a href="/community?type=client/">Сообщество</a> </li>
    ...
    <div class="col-md-9">
        <ul class="nav">
            <li class="active">
                <a href="/community?type=client/"><h2>Новости</h2></a>
            </li>
            <ul class="nav">
        ...
        <div class="project-table">
            ...
            <div class="">
                ...
                <div class="col-md-2">
                    <a href="news/add-client"><button type="button" class="btn btn-default"><h4>Добавить новость</h4></button></a>
                </div>
            </div>
                    ...
                    <c:forEach var="listValue" items="${newsList}">
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="table-responsive cell"><a href="news/${listValue.newsId}?role=client">${listValue.text}</a></div>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
