...
<div class="row">
        ...
        <div class="user-info-and-menu">
            ...
            <div class="btn-group btn-group-vertical">
                <form>
                    ...
                    <li class=""><a href="/community/?role=student">Сообщество</a> </li>
    ...
    <div class="col-md-9">
        <ul class="nav">
            <li class="active">
                <a href="/community/?role=student"><h2>Новости</h2></a>
            </li>
            <ul class="nav">
        ...
        <div class="container">
            <form:form method="post" modelAttribute="News" action="add-student">
                <form:select path="projectName" placeholder="Выберите проект" class="form-control" id="projectName" required="true">
                    <form:options items="${projects}"/>
                </form:select>
                <form:errors path="projectName"/><br/>
                <form:textarea cols="150" path="text" type="text" id="text" rows="5" value=""
