...
<div class="row">
    ...
    <div class="col-md-9">
        <ul class="nav">
            <li class="active">
                <a href="/community/?role=admin"><h2>Новости</h2></a>
            </li>
            <ul class="nav">
            ...
            <li><a href="/regulations/?role=admin"><h2>Правила</h2></a></li>
            <ul class="nav">
        ...
        <div class="project-table">
            ...
            <div class="">
                ...
                <div class="col-md-2">
                    <a href="/regulations/add-admin"><button type="button" class="btn btn-default"><h4>Добавить правило</h4></button></a>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <div class="dropdown" align="left">
                                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">${regulation.status.displayName}</button>
                                        <ul class="dropdown-menu">
                                            <li><a href="/regulations/approve/${regulation.id}?role=admin">Утверждено</a></li>
                                            <li><a href="/regulations/decline/${regulation.id}?role=admin">Отклонено</a></li>
                                        </ul>
                                        <a href="/regulations/delete/${regulation.id}?role=admin">
