...
CREATE TABLE `descriptions` (
  ...
  `status` varchar(45) NOT NULL DEFAULT 'AWAITING_MODERATION',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `word_id_fkey_idx` (`word_id`),
  KEY `topic_id_fkey_idx` (`topic_id`),
  KEY `description_sender_id_fkey_idx` (`sender_id`),
  CONSTRAINT `description_sender_id_fkey` FOREIGN KEY (`sender_id`) REFERENCES `students` (`students_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `topic_id_fkey` FOREIGN KEY (`topic_id`) REFERENCES `translation_topics` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `word_id_fkey` FOREIGN KEY (`word_id`) REFERENCES `vocabulary_words` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `descriptions` VALUES (1,1,'тестовое описание',1,1,0,'APPROVED'),(2,1,'другое описание',NULL,NULL,0,'AWAITING_MODERATION'),(3,1,'тест тест тест',NULL,NULL,0,'AWAITING_MODERATION'),(4,1,'lheudfsdf',NULL,NULL,0,'APPROVED');
...
INSERT INTO `groups` VALUES (0,'У82-13','2013'),(1,'У82-14','2014'),(2,'У82-15','2015'),(3,'иной ВУЗ','2000');
...
--
-- Table structure for table `moderator_comments`
--

DROP TABLE IF EXISTS `moderator_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `moderator_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `text_id_fkey_idx` (`text_id`),
  KEY `moderator_id_fkey_idx` (`moderator_id`),
  CONSTRAINT `moderator_id_fkey` FOREIGN KEY (`moderator_id`) REFERENCES `moderators` (`mod_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `text_id_fkey` FOREIGN KEY (`text_id`) REFERENCES `translation_texts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `moderator_comments`
--

LOCK TABLES `moderator_comments` WRITE;
/*!40000 ALTER TABLE `moderator_comments` DISABLE KEYS */;
INSERT INTO `moderator_comments` VALUES (1,'замечане',1,1,'2017-06-11 20:24:20');
/*!40000 ALTER TABLE `moderator_comments` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `standards` VALUES (1,'test standarts');
...
CREATE TABLE `translation_texts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `initial_text` mediumtext,
  `student_id` int(11) DEFAULT NULL,
  `result_text` mediumtext,
  `full_text` mediumtext,
  `status` varchar(45) DEFAULT 'UNASSIGNED',
  `standard_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `student_id_fkey_idx` (`student_id`),
  KEY `standard_id_fkey_idx` (`standard_id`),
  CONSTRAINT `standard_id_fkey` FOREIGN KEY (`standard_id`) REFERENCES `standards` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `student_id_fkey` FOREIGN KEY (`student_id`) REFERENCES `students` (`students_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `translation_texts` VALUES (1,'test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test ',0,'gdhjdfhjfdggdfjgjdfg','test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test ','NEEDS_REVIEW',1);
/*!40000 ALTER TABLE `translation_texts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `translation_topics`
--

DROP TABLE IF EXISTS `translation_topics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `translation_topics`
--

LOCK TABLES `translation_topics` WRITE;
/*!40000 ALTER TABLE `translation_topics` DISABLE KEYS */;
INSERT INTO `translation_topics` VALUES (1,'тест');
/*!40000 ALTER TABLE `translation_topics` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `translations` (
  ...
  `status` varchar(45) NOT NULL DEFAULT 'AWAITING_MODERATION',
  PRIMARY KEY (`id`),
  KEY `translation_word_id_fkey_idx` (`word_id`),
  KEY `translation_topic_id_fkey_idx` (`topic_id`),
  KEY `translation_sender_id_fkey_idx` (`sender_id`),
  CONSTRAINT `translation_word_id_fkey` FOREIGN KEY (`word_id`) REFERENCES `vocabulary_words` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `translations` VALUES (2,1,'тест',1,1,1,'APPROVED'),(3,1,'другой перевод',NULL,NULL,2,'AWAITING_MODERATION'),(4,1,'другой перевод',NULL,NULL,0,'APPROVED');
...
LOCK TABLES `vocabulary_words` WRITE;
/*!40000 ALTER TABLE `vocabulary_words` DISABLE KEYS */;
INSERT INTO `vocabulary_words` VALUES (1,'test'),(2,'dfsfsdf');
/*!40000 ALTER TABLE `vocabulary_words` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-07-08 22:56:58
